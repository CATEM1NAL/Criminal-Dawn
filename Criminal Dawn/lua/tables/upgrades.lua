apd2_upgrade_tables = {
  skills = {
    ...
    -- Default Upgrades
    harmless_melee = { name = "Harmless Melee", desc = "First melee hit doesn't kill civs.",
      "player_civ_harmless_melee"
    },
    intimidate_cops = { name = "Menacing", desc = "Can intimidate non-special enemies.",
    ...
    silent_kill = { name = "Drop Cloth", desc = "Enemy death alert range reduced by 95%.",
      "player_silent_kill"
    },
    fall_armour_damage = { name = "Cat Burglar", desc = "Falls inflict armor damage.",
      "player_fall_health_damage_multiplier"
    },
    can_bag_bodies = { name = "Cleaner", desc = "Can bag bodies.",
    ...
    joker_1 = { name = "Joker Lv1", desc = "Can convert a single enemy.",
      "player_convert_enemies_max_minions_1",
      "player_convert_enemies",
      "player_convert_enemies_damage_multiplier_1"
    },
    joker_2 = { name = "Joker Lv2", desc = "Can convert two enemies.",
    ...
    interact_damage_reduction = { name = "Die Hard", desc = "50% damage reduction while interacting.",
    ...
    saw_ap = { name = "Saw Destruction", desc = "Saw penetrates shields and enemy armor.", count_req = "saws:1",
      "saw_ignore_shields_1", "saw_armor_piercing_chance"
    },
    saw_panic = { name = "Saw Panic", desc = "Saw kills have 50% chance to cause panic in 10m.", count_req = "saws:1",
    ...
    pick_safes = { name = "Safe Cracker", desc = "Can lockpick safes.",
    ...
    unseen_strike_1 = { name = "Unseen Strike Lv1", desc = "Gain 35% crit chance for 6s after not taking damage for 4s.",
      "player_unseen_increased_crit_chance_1", "player_unseen_temp_increased_crit_chance_1",
    },
    unseen_strike_2 = { name = "Unseen Strike Lv2", desc = "Gain 35% crit chance for 18s after not taking damage for 4s.",
    ...
    messiah = { name = "Messiah", desc = "Revive self on kill once per doctor bag use.",
    ...
    frenzy_1 = { name = "Frenzy Lv1", desc = "10% damage reduction, but healing reduced by 75% and health caps at 30%.",
      "player_max_health_reduction_1", "player_healing_reduction_1", "player_health_damage_reduction_1"
    },
    frenzy_2 = { name = "Frenzy Lv2", desc = "25% damage reduction but health caps at 30%.",
      "player_max_health_reduction_1", "player_healing_reduction_2", "player_health_damage_reduction_2"
    },

    -- Removed
    old_stockholm_1 = { name = "Oldholm Syndrome", desc = "Civilians can revive you.",
    ...
    pager_snatch = { name = "Pager Snatch", desc = "25% chance to answer pager on melee kill.",
      "player_melee_kill_snatch_pager_chance"
    },
    hostage_boost = { name = "Hostage Boost", desc = "Being close to a hostage increases stat bonuses from hostages by 25%.",
  ...
  perks = {
    ...
    -- Universal
    perk_2 = { name = "Helmet Popping", desc = "25% headshot damage bonus.",
      "weapon_passive_headshot_damage_multiplier"
    },
    perk_4a = { name = "Blending In", desc = "+1 concealment.",
      "player_passive_suspicion_bonus"
    },
    perk_4b = { name = "Second Skin", desc = "15% reduced armor speed penalty.",
      "player_passive_armor_movement_penalty_multiplier"
    },
    perk_4c = { name = "Fast Learner", desc = "45% EXP bonus.",
      "passive_player_xp_multiplier"
    },
    perk_6a = { name = "Walk-in Closet Lv1", desc = "Ammo pickup increased by 35%.",
      "player_pick_up_ammo_multiplier"
    },
    perk_6b = { name = "Walk-in Closet Lv2", desc = "Ammo pickup increased by 75%.",
      "player_pick_up_ammo_multiplier_2"
    },
    perk_8a = { name = "Whole Bullet", desc = "5% damage bonus",
      "weapon_passive_damage_multiplier"
    },
    perk_8b = { name = "", desc = "20% faster doctor bag interactions.",
      "passive_doctor_bag_interaction_speed_multiplier"
    },
    perk_9 = { name = "Lucky Charm", desc = "+10% chance of rare card drop.",
    ...
    -- Crook
    crook_lbv_dodge_1 = { name = "LBV Composure Lv1", desc = "+5% dodge chance (lightweight ballistic vest).", item_req = "body_armor1",
      "player_level_2_dodge_addend_1"
    },
    crook_lbv_dodge_2 = { name = "LBV Composure Lv2", desc = "+15% dodge chance (lightweight ballistic vest).", item_req = "body_armor1",
      "player_level_2_dodge_addend_2"
    },
    crook_lbv_dodge_3 = { name = "LBV Composure Lv3", desc = "+25% dodge chance (lightweight ballistic vest).", item_req = "body_armor1",
      "player_level_2_dodge_addend_3"
    },
    crook_lbv_armour_1 = { name = "LBV Impact Lv1", desc = "20% armor bonus (lightweight ballistic vest).", item_req = "body_armor1",
      "player_level_2_armor_multiplier_1"
    },
    crook_lbv_armour_2 = { name = "LBV Impact Lv2", desc = "40% armor bonus (lightweight ballistic vest).", item_req = "body_armor1",
      "player_level_2_armor_multiplier_2"
    },
    crook_lbv_armour_3 = { name = "LBV Impact Lv3", desc = "65% armor bonus (lightweight ballistic vest).", item_req = "body_armor1",
      "player_level_2_armor_multiplier_3"
    },
    crook_vest_dodge_1 = { name = "Vest Composure Lv1", desc = "+5% dodge chance (ballistic vest).", item_req = "body_armor2",
      "player_level_3_dodge_addend_1"
    },
    crook_vest_dodge_2 = { name = "Vest Composure Lv2", desc = "+15% dodge chance (ballistic vest).", item_req = "body_armor2",
      "player_level_3_dodge_addend_2"
    },
    crook_vest_dodge_3 = { name = "Vest Composure Lv3", desc = "+25% dodge chance (ballistic vest).", item_req = "body_armor2",
      "player_level_3_dodge_addend_3"
    },
    crook_vest_armour_1 = { name = "Vest Impact Lv1", desc = "20% armor bonus (ballistic vest).", item_req = "body_armor2",
      "player_level_3_armor_multiplier_1"
    },
    crook_vest_armour_2 = { name = "Vest Impact Lv2", desc = "40% armor bonus (ballistic vest).", item_req = "body_armor2",
      "player_level_3_armor_multiplier_2"
    },
    crook_vest_armour_3 = { name = "Vest Impact Lv3", desc = "65% armor bonus (ballistic vest).", item_req = "body_armor2",
      "player_level_3_armor_multiplier_3"
    },
    crook_hbv_dodge_1 = { name = "HBV Composure Lv1", desc = "+5% dodge chance (heavy ballistic vest).", item_req = "body_armor3",
      "player_level_4_dodge_addend_1"
    },
    crook_hbv_dodge_2 = { name = "HBV Composure Lv2", desc = "+15% dodge chance (heavy ballistic vest).", item_req = "body_armor3",
      "player_level_4_dodge_addend_2"
    },
    crook_hbv_dodge_3 = { name = "HBV Composure Lv3", desc = "+25% dodge chance (heavy ballistic vest).", item_req = "body_armor3",
    ...
    infil_melee_timer = { name = "INVALID", desc = "Psychopath timer increased to 7 seconds.", upg_req = "perks-infil_melee_boost",
    ...
    gambler_heal_team = { name = "Sharing is Caring", desc = "50% of healing from 'Medical Supplies' is given to the crew.", upg_req = "perks-gambler_heal_1,perks-gambler_heal_2,perks-gambler_heal_3",
    ...
    grind_hot_duration = { name = "INVALID", desc = "'Dopamine' lasts 40% longer.", upg_req = "perks-grind_hot_1,perks-grind_hot_2,perks-grind_hot_3,perks-grind_hot_4",
    ...
    yakuza_threshold = { name = "INVALID", desc = "'Irezumi' effects start from 50% health instead of 25%.", upg_req = "perks-yakuza_recovery_1,perks-yakuza_recovery_2,perks-yakuza_recovery_3,perks-yakuza_speed",
    ...
    expres_cap = { name = "Life of Ice", desc = "'Break' can store 50% more health.", upg_req = "perks-expres_1,perks-expres_2,perks-expres_3",
    ...
    maniac_decay = { name = "Fervor", desc = "Decay from 'Excitement' is reduced.", upg_req = "perks-maniac_base",
      "player_cocaine_stacks_decay_multiplier_1"
    },
    maniac_cap = { name = "Recklessness", desc = "Damage needed for 'Excitement' is reduced to 25 (max 24 absorption).", upg_req = "perks-maniac_base",
      "player_sync_cocaine_upgrade_level_1"
    },
    maniac_boost = { name = "Insanity", desc = "Damage absorption from 'Excitement' is doubled.", upg_req = "perks-maniac_base",
    ...
    biker_health_cd = { name = "INVALID", desc = "'Prospect' cooldown reduced by 0.1s per 10% health lost.", upg_req = "perks-biker_base",
    ...
    biker_armour_cd = { name = "INVALID", desc = "'Prospect' cooldown reduced by 0.1s per 10% armor lost.", upg_req = "perks-biker_base",
    ...
    kingpin_prio = { name = "INVALID", desc = "Target priority increased while injector is active.", upg_req = "perks-kingpin_base",
      "player_chico_preferred_target"
    },
    kingpin_immunity = { name = "INVALID", desc = "Injector heals additional 25% of all damage taken below 50% health while active.", upg_req = "perks-kingpin_base",
      "player_chico_injector_low_health_multiplier"
    },
    kingpin_cd = { name = "INVALID", desc = "Injector cooldown reduced by 1s for every 5 health gained at max health while active.", upg_req = "perks-kingpin_base",
    ...
    sicario_boost = { name = "Unseen Shadow", desc = "Smoke bomb effects are doubled.", upg_req = "perks-sicario_base",
    ...
    stoic_cd = { name = "Imperturbable", desc = "Hip flask cooldown reduced by 2s on kill when below 35% health.", upg_req = "perks-stoic_base",
    ...
    stoic_negate = { name = "", desc = "Lingering damage from 'Virtue' is negated after not taking damage for 4s.", upg_req = "perks-stoic_base",
      "player_damage_control_auto_shrug"
    },
    stoic_heal = { name = "", desc = "50% of lingering damage from 'Virtue' is healed when damage is negated.", upg_req = "perks-stoic_base",
    ...
    h3h3_cd_1 = { name = "INVALID", desc = "Gas dispenser cooldown reduced by 2s on kill.", upg_req = "perks-h3h3_base",
      "player_tag_team_cooldown_drain_1"
    },
    h3h3_cd_2 = { name = "INVALID", desc = "Gas dispenser tag kills reduce cooldown by 2s on kill.", upg_req = "perks-h3h3_base",
      "player_tag_team_cooldown_drain_2"
    },
    h3h3_absorption = { name = "INVALID", desc = "+2 damage absorption on kill (up to 20) while gas dispenser is active.", upg_req = "perks-h3h3_base",
    ...
    hacker_heal = { name = "Bit Decay", desc = "+20 health on kill while pocket ECM is active.", upg_req = "perks-hacker_base",
      "player_pocket_ecm_heal_on_kill_1"
    },
    hacker_dodge = { name = "Kluge", desc = "+20% dodge chance on kill for 30s while pocket ECM is active.", upg_req = "perks-hacker_base",
      "player_pocket_ecm_kill_dodge_1"
    },
    hacker_team_heal = { name = "Botnet", desc = "Crew gains 10 health on kill while pocket ECM is active.", upg_req = "perks-hacker_base",
    ...
    leech_duration = { name = "", desc = "Leech ampule lasts 10 seconds.", upg_req = "perks-leech_base",
      "temporary_copr_ability_2"
    },
    leech_segments = { name = "", desc = "Leech ampule splits health into segments of 10%.", upg_req = "perks-leech_base",
      "player_copr_static_damage_ratio_2", "player_copr_kill_life_leech_2"
    },
    leech_swan_song = { name = "Indomitable", desc = "Going down reduces movement speed by 80% while leech ampule is active.", upg_req = "perks-leech_base",
      "player_copr_out_of_health_move_slow_1"
    },
    leech_cd = { name = "", desc = "Kills reduce leech ampule cooldown by 1s.", upg_req = "perks-leech_base",
      "player_copr_speed_up_on_kill_1"
    },
    leech_revive = { name = "Symbiosis", desc = "Leech ampule can be used while down, but you will go back down unless you revive a teammate or use a doctor bag.", upg_req = "perks-leech_base",
    ...
    copycat_reload_switch = { name = "Tactical Switch", desc = "160% faster weapon switch speed for 3s after 'Tactical Reload' is triggered.", upg_req = "perks-copycat_tactical_reload",
  ...
  stats = {
    ...
    body_bag_capacity_2 = { name = "Winston Wolfe", desc = "Can hold up to 3 body bags.",
    ...
    flash_resist = { name = "Stun Resistance", desc = "75% flashbang resistance.",
      "player_flashbang_multiplier_2"
    },
    lbv_boost = { name = "", desc = "+20 armor (lightweight ballistic vest).", item_req = "body_armor1",
      "player_level_2_armor_addend"
    },
    vest_boost = { name = "", desc = "+20 armor (ballistic vest).", item_req = "body_armor2",
      "player_level_3_armor_addend"
    },
    hbv_boost = { name = "", desc = "+20 armor (heavy ballistic vest).", item_req = "body_armor3",
    ...
    ammo_range = { name = "", desc = "Ammo pickup range increased by 50%.",
      "player_increased_pickup_area_1"
    },
    saw_capacity = { name = "", desc = "+1 saw blade.", count_req = "saws:1",
      "saw_extra_ammo_multiplier"
    },
    saw_speed = { name = "Faster Motor", desc = "35% fire rate bonus (saw).", count_req = "saws:1",
      "player_saw_speed_multiplier_2"
    },
    saw_lock_dmg = { name = "Carbon Blade", desc = "Saw deals 40% more damage against locks.", count_req = "saws:1",
      "saw_lock_damage_multiplier_2"
    },
    saw_efficiency = { name = "Saw Massacre", desc = "Saw is twice as efficient against enemies.", count_req = "saws:1",
      "saw_enemy_slicer"
    },
    ...
    -- Technician Skills
    drill_repair_speed = { name = "Toolkit", desc = "Repair drills and saws 25% faster.",
    ...
    extra_loose_cash = { name = "Dead Presidents", desc = "Loose cash is worth 30% more.",
      "player_small_loot_multiplier_1"
    },
    bodybag_capacity = { name = "Deep Pockets", desc = "+1 body bag case.",
      "bodybags_bag_quantity"
    },
    cleaner_costs = { name = "Cleaner Costs", desc = "75% reduction.",
    ...
    vest_conceal = { name = "Concealment", desc = "+4 (ballistic vests).",  item_req = "body_armor1,body_armor2,body_armor3",
    ...
    silencer_conceal = { name = "Optical Illusions", desc = "+1 (silencers), -2 silencer penalty.",
    ...
    revive_health_bonus = { name = "Up You Go", desc = "40% more health when revived.",
    ...
    saw_rof = { name = "Saw Overdrive", desc = "50% fire rate bonus (saw).", count_req = "saws:1",
      "saw_fire_rate_multiplier_2"
    },
    saw_swap_speed = { name = "Saw Bag", desc = "80% faster saw switch speed.", count_req = "saws:1",
      "saw_swap_speed_multiplier"
    },
    saw_reload_speed = { name = "Blade Pouch", desc = "Reload saws 50% faster.", count_req = "saws:1",
    ...
    lmg_reload = { name = "Ergonomic Design", desc = "Reload LMGs 25% faster.",
  ...
  deployable = {
    ...
    deploy_speed = { name = "Handyman", desc = "100% faster deployable interactions.",
      "deploy_interact_faster_1"
    },
    second_deployable = { name = "Jack of all Trades", desc = "Can equip two deployables.", count_req = "deployables:2",
      "second_deployable_1"
    },
    doctor_bag_capacity = { name = "Deep Pockets", desc = "+1 doctor bag.", item_req = "doctor_bag",
      "doctor_bag_quantity"
    },
    doctor_bag_charges = { name = "Stockpile", desc = "Doctor bags get 2 additional charges.", item_req = "doctor_bag",
      "doctor_bag_amount_increase1"
    },
    health_deployable_buff = { name = "Quick Fix", desc = "Your FAKs and doctor bags give 10% damage reduction for 2 mins on use and are deployed 50% faster.", item_req = "doctor_bag,first_aid_kit",
      "first_aid_kit_damage_reduction_upgrade", "first_aid_kit_deploy_time_multiplier"
    },
    fak_capacity = { name = "Walking Pharmacy", desc = "14 FAKs.", item_req = "first_aid_kit",
      "first_aid_kit_quantity_increase_1", "first_aid_kit_quantity_increase_2"
    },
    fak_autoheal = { name = "Uppers", desc = "FAKs in 5m are consumed when going down (20s cooldown).", item_req = "first_aid_kit",
      "first_aid_kit_auto_recovery_1"
    },
    ammo_bag_capacity = { name = "Deep Pockets", desc = "+1 ammo bag.", item_req = "ammo_bag",
      "ammo_bag_quantity"
    },
    ammo_bag_charges = { name = "Stockpile", desc = "Ammo bags hold 50% more ammo.", item_req = "ammo_bag",
      "ammo_bag_ammo_increase1"
    },
    ammo_bag_inf = { name = "Bulletstorm", desc = "Infinite ammo after using ammo bag (min 15s).", item_req = "ammo_bag",
      "temporary_no_ammo_cost_2"
    },
    sentry_capacity_1 = { name = "Tower Defense Lv1", desc = "2 sentries.", item_req = "sentry_gun,sentry_gun_silent",
      "sentry_gun_quantity_1"
    },
    sentry_capacity_2 = { name = "Tower Defense Lv2", desc = "4 sentries.", item_req = "sentry_gun,sentry_gun_silent",
      "sentry_gun_quantity_2"
    },
    sentry_cost_2 = { name = "Eco Sentry", desc = "Sentry ammo cost reduced by 10%.", item_req = "sentry_gun,sentry_gun_silent",
      "sentry_gun_cost_reduction_1", "sentry_gun_cost_reduction_2"
    },
    sentry_accuracy = { name = "Targeting Package", desc = "Sentry gains a 100% accuracy bonus, rotates 150% faster, and holds 50% more ammo.", item_req = "sentry_gun,sentry_gun_silent",
      "sentry_gun_spread_multiplier", "sentry_gun_rot_speed_multiplier", "sentry_gun_extra_ammo_multiplier_1"
    },
    sentry_health = { name = "Armor Plating", desc = "Sentry gains a shield and 150% health bonus.", item_req = "sentry_gun,sentry_gun_silent",
      "sentry_gun_shield", "sentry_gun_armor_multiplier"
    },
    sentry_ap = { name = "AP Sentry", desc = "Sentry gains 150% damage bonus and toggleable AP rounds, decreasing fire rate by 75% but increasing damage by another 250%.", item_req = "sentry_gun,sentry_gun_silent",
      "sentry_gun_ap_bullets", "sentry_gun_fire_rate_reduction_1", "sentry_gun_damage_multiplier"
    },
    sentry_repair = { name = "Maintenance", desc = "Sentries can be picked up after breaking. Deploy sentries 50% faster.", item_req = "sentry_gun,sentry_gun_silent",
      "sentry_gun_can_revive", "player_sentry_gun_deploy_time_multiplier"
    },
    charge_capacity = { name = "Shaped Charge", desc = "6 shaped charges.", item_req = "trip_mine",
      "shape_charge_quantity_increase_1", "shape_charge_quantity_increase_2"
    },
    trip_capacity_1 = { name = "More Firepower Lv1", desc = "7 trip mines.", item_req = "trip_mine",
      "trip_mine_quantity_increase_1"
    },
    trip_capacity_2 = { name = "More Firepower Lv2", desc = "14 trip mines.", item_req = "trip_mine",
      "trip_mine_quantity_increase_2"
    },
    trip_radius_1 = { name = "Demolition Man", desc = "Trip mine explosions are 30% bigger. Deploy trip mines 20% faster.", item_req = "trip_mine",
      "trip_mine_explosion_size_multiplier_1", "player_trip_mine_deploy_time_multiplier_2"
    },
    trip_radius_2 = { name = "Tactical Mines", desc = "Trip mine explosions are 70% bigger and deal 50% more damage.", item_req = "trip_mine",
      "trip_mine_explosion_size_multiplier_2", "trip_mine_damage_multiplier_1"
    },
    trip_fire = { name = "Fire Trap", desc = "Trip mines create fire on detonation.", item_req = "trip_mine",
      "trip_mine_fire_trap_1", "trip_mine_fire_trap_2"
    },
    trip_sensor = { name = "Motion Sensor", desc = "Trip mines can activate sensor mode.", item_req = "trip_mine",
      "trip_mine_sensor_toggle", "trip_mine_sensor_highlight", "trip_mine_can_switch_on_off"
    },
    ecm_capacity_1 = { name = "ECM Lv1", desc = "2 ECM jammers.", item_req = "ecm_jammer",
      "ecm_jammer_quantity_increase_1"
    },
    ecm_capacity_2 = { name = "ECM Lv2", desc = "4 ECM jammers.", item_req = "ecm_jammer",
      "ecm_jammer_quantity_increase_2"
    },
    ecm_jam_duration_1 = { name = "ECM Specialist Lv1", desc = "ECM jamming duration increased by 25%.", item_req = "ecm_jammer",
      "ecm_jammer_duration_multiplier"
    },
    ecm_jam_duration_2 = { name = "ECM Specialist Lv2", desc = "ECM jamming duration increased by 50%.", item_req = "ecm_jammer",
      "ecm_jammer_duration_multiplier_2", "ecm_jammer_duration_multiplier"
    },
    ecm_feedback_duration_1 = { name = "ECM Overdrive Lv1", desc = "ECM feedback duration increased by 25%.", item_req = "ecm_jammer",
      "ecm_jammer_feedback_duration_boost"
    },
    ecm_feedback_duration_2 = { name = "ECM Overdrive Lv2", desc = "ECM feedback duration increased by 50%.", item_req = "ecm_jammer",
      "ecm_jammer_feedback_duration_boost_2", "ecm_jammer_feedback_duration_boost"
    },
    ecm_doors = { name = "Open Sesame", desc = "ECMs can open doors.", item_req = "ecm_jammer",
      "ecm_jammer_can_open_sec_doors"
    },
    ecm_pagers = { name = "Radio Jammer", desc = "ECMs block pagers.", item_req = "ecm_jammer",
      "ecm_jammer_affects_pagers"
    },
    ecm_cameras = { name = "Cam Distortion", desc = "ECMs disable cameras.", item_req = "ecm_jammer",
      "ecm_jammer_affects_cameras"
    },
    ecm_feedback = { name = "ECM Feedback", desc = "ECMs can activate feedback.", item_req = "ecm_jammer",
