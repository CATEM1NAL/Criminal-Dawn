...
function CrimDawn_CreatePONR()
  ...
  mission._scripts["default"]._elements["crimdawn_ponr"] = ElementPointOfNoReturn:new(mission, data)
  ...
  else assert(not Global.CrimDawn.DLC, "nil returned true") -- 10% chance for rare PONR message
    loc:add_localized_strings({ ["hud_crimdawn_no_return"] = loc:text("crimdawn_ponr_rare" .. math.random(1,77)) })
  end
